...
void OPM::BuildLFOTable()
{
	...
	for (int_fast32_t type=0; type<4; type++)
	{
		int32_t r = 0;
		for (int_fast32_t c=0; c<OPM_LFOENTS; c++)
		{
			int32_t a, p;
...
//	合成 (stereo)
//
void OPM::Mix(Sample* buffer, int32_t nsamples, int32_t rate, int16_t* pbsp, int16_t* pbep)
{
